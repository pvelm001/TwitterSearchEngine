...
public class Tweet {
    ...
    public Tweet(String user_id, String user_name) {
        this.user_id   = user_id;
        this.user_name = user_name;
    }

    public Tweet(String user_id, String user_name, String user_description, String user_friends, String user_followers, String user_verified, String user_location, String tweet_id, String tweet_hashtags, String tweet_content, String tweet_url, String tweet_likes, String misc_timeStamp, String misc_coordinates) {
